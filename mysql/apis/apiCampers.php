...
foreach ($datoscampers as $camper) {
    ...
    mysqli_query($conexion,"INSERT INTO campers (id_camper,imagen,nombre,edad,promedio,nivelCAmpus,nivelIngles,especialidad, direccion, celular, Ingles, Ser, Review, Skills, Asitencia) VALUES ('".$camper['id_camper']."','".$camper['imagen']."','".$camper['nombre']."','".$camper['edad']."','".$camper['promedio']."','".$camper['nivelCAmpus']."','".$camper['nivelIngles']."','".$camper['especialidad']."','".$camper['direccion']."','".$camper['celular']."','".$camper['Ingles']."','".$camper['Ser']."','".$camper['Review']."','".$camper['Skills']."','".$camper['Asitencia']."')");	
